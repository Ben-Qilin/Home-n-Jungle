...
const AuthModal = ({showModal, setShowModal}) => {
    ...
    <>
        {showModal? (
       <div style={{transition: 'opacity 5s ease-in-out', opacity: showModal ? 1 : 0, visibility: showModal ? 'visible' : 'hidden', zIndex: '20',position: 'absolute',top: '0', left: '0', backgroundColor: 'rgba(255, 255, 255, 0.25)',backdropFilter: 'blur(15px)', height: "100vh", width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', WebkitFilter: 'blur(15px)'}}> 
